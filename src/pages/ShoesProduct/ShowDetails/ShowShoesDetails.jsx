...
import "./ShowShoesDetails.css";

const ShowShoesDetails = () => {
  const { id } = useParams();
  ...
  const product = shoesCategory.find((item) => item._id === id);
        ...
        <div className="price-alert-container">
          ...
          {!alertSet ? (
            ...
            <div className="alert-confirmation">
              ...
              <button className="btn-alert" onClick={() => setAlertSet(false)}>
                Set New Alert
              </button>
            </div>
          )}
      ...
      <div className="ratings">
        ...
        {[1, 2, 3, 4, 5].map((star) => (
          <span
            ...
            className={`star ${star <= rating ? "text-yellow" : "text-gray"}`}
          >
            ★
          </span>
        ))}
...
export default ShowShoesDetails;
